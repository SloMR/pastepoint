...
export const translations: Record<LanguageCode, TranslationData> = {
  ...
  ar: {
    ...
    PUBLIC_ROOM_INFO:
      'أنت في غرفة عامة على شبكتك المحلية. يمكن لأي شخص يصل إلى PastePoint من نفس الشبكة الانضمام إلى هذه الغرفة وتبادل الرسائل.',
    ...
    SESSION_RECONNECT_FAILED: 'فشل إعادة الاتصال بالجلسة. يرجى تحديث الصفحة.',
    AUTO_REFRESH_NOTICE: 'سيتم تحديث الصفحة لإعادة الاتصال.',
    CANCELLED: 'ألغيت',
    DECLINED: 'مرفوضة',
    ERROR: 'خطأ',
    SUCCESS: 'تم بنجاح',
